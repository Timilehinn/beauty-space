...
import { MdBarChart, MdChat, MdSettings } from 'react-icons/md'
...
export default function ManagerSidebarMenu() {
    ...
    >
      <div className='flex flex-col justify-center items-center w-full gap-5 divide-y divide-solid divide-lightgrey'>
        ...
        <div className='w-full py-8 3xl:py-24 3xl:gap-8 special:px-2 xxl:px-5 xl:px-2 lg:px-2 flex flex-col justify-center items-center gap-5 '>
          ...
          {/* Conditionally render "Insight" and "Inbox" links based on permissions */}
          {hasPermission('insights:view') && (
            ...
            >
              <MdBarChart className='text-2xl 3xl:text-4xl ' />
            </Link>
          )}
          ...
          {hasPermission('messages:view') && (
            ...
            >
              <MdChat className='text-2xl 3xl:text-4xl ' />
            </Link>
          )}
        </div>
      </div>
