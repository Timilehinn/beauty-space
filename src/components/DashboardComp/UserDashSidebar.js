...
import { MdCalendarToday, MdOutlineBarChart, MdSettings } from 'react-icons/md'
...
export default function UserDashSidebar() {
  ...
  const steps = [
    ...
    },
    {
      target: '#UserBookings',
      content:
        'Click here to check your all your services, booked services, and unbooked services. You can also edit and delete services here.',
    },
    {
      target: '#inbox',
      content: 'You can chat with your client here',
    },
    {
      target: '#expenses',
      content:
        'Click here to view your expenses, transactions, check most visited services by you, and reviews on your services.',
    },
    {
      target: '#settings',
      content:
